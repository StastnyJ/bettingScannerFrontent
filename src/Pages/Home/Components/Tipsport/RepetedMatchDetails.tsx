...
export default function RepetedMatchDetails({ newTipsportReq, setNewTipsportReq, chats, selectedChatId, setSelectedChat }: propsType) {
  if (newTipsportReq.apiUrl !== "/requests/v1/repeatedKeyword/") setNewTipsportReq({ ...newTipsportReq, apiUrl: "/requests/v1/repeatedKeyword/" });
